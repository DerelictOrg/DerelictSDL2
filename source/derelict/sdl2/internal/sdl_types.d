...
enum Uint8 SDL_MAX_UINT8 = Uint8.max;
enum Uint8 SDL_MIN_UINT8 = Uint8.min;
enum Sint16 SDL_MAX_SINT16 = Sint16.max;
enum Sint16 SDL_MIN_SINT16 = Sint16.min;
enum Uint16 SDL_MAX_UINT16 = Uint16.max;
enum Uint16 SDL_MIN_UINT16 = Uint16.min;
enum Sint32 SDL_MAX_SINT32 = Sint32.max;
enum Sint32 SDL_MIN_SINT32 = Sint32.min;
enum Uint32 SDL_MAX_UINT32 = Uint32.max;
enum Uint32 SDL_MIN_UINT32 = Uint32.min;
enum Sint64 SDL_MAX_SINT64 = Sint64.max;
enum Sint64 SDL_MIN_SINT64 = Sint64.min;
enum Uint64 SDL_MAX_UINT64 = Uint64.max;
enum Uint64 SDL_MIN_UINT64 = Uint64.min;
...
mixin(MakeEnum!SDL_BlendOperation);
...
mixin(MakeEnum!SDL_BlendFactor);
...
mixin(MakeEnum!SDL_JoystickType);
...
mixin(MakeEnum!SDL_YUV_CONVERSION_MODE);
    ...
    union info_ {
        static if(Derelict_OS_Windows) {
            struct win_ {
               void* window;
               void* hdc;
               void* hinstance; // Added in SDL 2.0.6!
            }
            win_ win;
        }
        ...
        static if(Derelict_OS_Mac || Derelict_OS_iOS) {
            ...
            struct uikit_ {
                void *window;
                uint framebuffer;        // Added in SDL 2.0.4!
                uint colorbuffer;        // Added in SDL 2.0.4!
                uint resolveFramebuffer; // Added in SDL 2.0.4!
            }
            uikit_ uikit;
        }
...
mixin(MakeEnum!SDL_DisplayEventID);
...
mixin(MakeEnum!SDL_DisplayOrientation);
...
mixin(MakeEnum!SDL_GLContextResetNotification);
