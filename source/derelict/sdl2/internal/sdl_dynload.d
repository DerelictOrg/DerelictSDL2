...
protected:
      ...
      override void loadSymbols()
      {
            ...
            bindFunc(cast(void**)&SDL_JoystickGetDeviceProductVersion, "SDL_JoystickGetDeviceProductVersion");
...
private:
      ShouldThrow allowSDL_2_0_0(string symbolName) {
            switch(symbolName) {
      ...
      ShouldThrow allowSDL_2_0_1(string symbolName)
      {
            switch(symbolName) {
      ...
      ShouldThrow allowSDL_2_0_2(string symbolName)
      {
            static if(Derelict_OS_WinRT) {
                  switch(symbolName) {
      ...
      ShouldThrow allowSDL_2_0_3(string symbolName)
      {
            switch(symbolName) {
      ...
      ShouldThrow allowSDL_2_0_4(string symbolName)
      {
            switch(symbolName) {
