...
static if(staticTTF) {
    extern(C) @nogc nothrow {
        ...
        SDL_Surface* TTF_RenderUNICODE_Blended_Wrapped(TTF_Font*,const(Uint16)*,SDL_Color,Uint32);
    ...
    alias DerelictSDL2TTF = DerelictSDL2ttf;
